...
*(1,824 characters including spaces. arXiv's limit is 1,920.)*

## Comments field

> 9 pages. Open artifact, pipeline and SHACL shapes archived at https://doi.org/10.5281/zenodo.21970543 and developed at https://github.com/fabio-rovai/bank-register-ontology. All figures reproducible from public sources: FDIC BankFind API, GLEIF golden copy of 16 August 2026, Federal Reserve MDRM.
...
## Paper outline (written: see `paper/paper.tex`, 9 pages)
...
The Zenodo DOI now exists (concept `10.5281/zenodo.21970543`) and is already cited in the paper's data availability section, so this precondition is met. Some venues, the Semantic Web Journal among them, require a stable archived URL and will not accept GitHub alone.
